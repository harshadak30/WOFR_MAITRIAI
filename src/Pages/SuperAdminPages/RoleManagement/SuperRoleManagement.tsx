...
const SuperRoleManagement: React.FC<{ isReadOnly: boolean }> = ({
  ...
  const submitEditPermission = useCallback(async () => {
    ...
    const success = await handleUpdateSuperAdminRoleMapping(
                      ...
                      >
                        ...
                        <td className="px-3 lg:px-6 py-4 whitespace-nowrap">
                          <button
                            ...
                            disabled={isReadOnly}
                            className="inline-flex items-center justify-center p-2 text-blue-600 hover:text-blue-800 hover:bg-blue-50 rounded-lg transition-all duration-200 disabled:text-gray-400 disabled:hover:bg-transparent disabled:cursor-not-allowed"
                            title="Edit mapping"
                          >
                            <Edit2 size={16} />
                          </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <ResponsiveDropdown
                  ...
                  onSelect={(value) => setEditSelectedModules(Array.isArray(value) ? value : [value])}
              ...
              <div className="space-y-2">
                ...
                <ResponsiveDropdown
                  ...
                  onSelect={(value) => setEditSelectedActions(Array.isArray(value) ? value[0] : value)}
                  placeholder="Choose Action..."
