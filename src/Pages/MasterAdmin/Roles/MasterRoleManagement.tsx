...
//         if (selectedRole) {
//           toggleDropdown(-1, 'module'); // Close dropdown
//         }
//       }
//     };
...
//                                 onSelectionChange={(selected) => handleApply(role.role_id, selected, 'module')}
...
//                                 onSelectionChange={(selected) => handleApply(role.role_id, selected, 'action')}
