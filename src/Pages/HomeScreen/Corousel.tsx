    ...
    <div className="w-full px-4 md:hidden">
      ...
      <div className="w-full mb-8 animate-fade-in">
        ...
        <p className="text-sm text-gray-600 text-center opacity-80">
         Choose us for a transformative experience in financial reporting.
         Our offerings not only encompass financial statement preparation, GAAP conversion, and regulatory compliance but also empower you to focus on your business priorities
        </p>
      </div>
  ...
  const desktopView = (
    <div className="w-full hidden md:block">
      ...
      <div className="w-full mb-10 text-center">
        ...
        <p className="text-gray-600 text-lg opacity-80 max-w-4xl mx-auto">
          Choose us for a transformative experience in financial reporting. Our offerings not only encompass financial statement preparation, GAAP conversion, and regulatory compliance but also empower you to focus on your business priorities
        </p>
      </div>
