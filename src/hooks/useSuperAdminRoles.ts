...
// //         await axios.get(
// //           `/api/v1/assigned-user-role-module-actions?${queryString}&sort_by=role_id&order=asc`,
// //           {
// //             headers: getAuthHeaders(),
// //           }
// //         );
...
//       const { data }: { data: AssignedUserRoleModuleActionsResponse } =
//         await axios.get(
//           `http://192.168.29.82:8000/api/v1/assigned-user-role-module-actions?page=${queryParams.page}&limit=${queryParams.limit}&sort_by=assignment_date&order=asc`,
//           {
//             headers: getAuthHeaders(),
//           }
//         );
...
console.log("super_Admin_roles",data);
...
console.log("super_Admin_role_mappings",data);
  ...
  const fetchAssignedRoles = useCallback(async (params?: Partial<PaginationParams>) => {
    try {
      ...
      const { data }: { data: AssignedUserRoleModuleActionsResponse } =
        ...
        console.log("user_role_mappings",data);
